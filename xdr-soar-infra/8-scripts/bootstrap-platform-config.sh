...
XDR_SOAR_NGINX_SSL_PROTOCOLS="${XDR_SOAR_NGINX_SSL_PROTOCOLS:-TLSv1.3}"
XDR_SOAR_NGINX_SSL_CIPHERS="${XDR_SOAR_NGINX_SSL_CIPHERS:-TLS_AES_256_GCM_SHA384:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_128_GCM_SHA256}"
XDR_SOAR_NGINX_SSL_CONF_COMMAND_GROUPS="${XDR_SOAR_NGINX_SSL_CONF_COMMAND_GROUPS:-X25519MLKEM768:SecP256r1MLKEM768:X448MLKEM1024:X25519:secp256r1:secp384r1}"
XDR_SOAR_NGINX_SSL_CONF_COMMAND_SIGALGS="${XDR_SOAR_NGINX_SSL_CONF_COMMAND_SIGALGS:-mldsa65:p384_mldsa65:mldsa87:p521_mldsa87:ecdsa_secp384r1_sha384:rsa_pss_rsae_sha384:rsa_pkcs1_sha384}"
...
XDR_SOAR_NGINX_SSL_PROTOCOLS=$XDR_SOAR_NGINX_SSL_PROTOCOLS
XDR_SOAR_NGINX_SSL_CIPHERS=$XDR_SOAR_NGINX_SSL_CIPHERS
XDR_SOAR_NGINX_SSL_CONF_COMMAND_GROUPS=$XDR_SOAR_NGINX_SSL_CONF_COMMAND_GROUPS
XDR_SOAR_NGINX_SSL_CONF_COMMAND_SIGALGS=$XDR_SOAR_NGINX_SSL_CONF_COMMAND_SIGALGS
