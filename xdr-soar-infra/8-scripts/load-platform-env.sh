...
export XDR_SOAR_NGINX_SSL_PROTOCOLS="${XDR_SOAR_NGINX_SSL_PROTOCOLS:-TLSv1.3}"
export XDR_SOAR_NGINX_SSL_CIPHERS="${XDR_SOAR_NGINX_SSL_CIPHERS:-TLS_AES_256_GCM_SHA384:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_128_GCM_SHA256}"
export XDR_SOAR_NGINX_SSL_CONF_COMMAND_GROUPS="${XDR_SOAR_NGINX_SSL_CONF_COMMAND_GROUPS:-X25519MLKEM768:X25519:secp256r1}"
