...
- real Kafka/MQTT/AMQP client integration is not yet implemented
...
- real Kafka producers/consumers in the event-plane services
...
- implement a real Kafka producer in `ingest-gateway`
